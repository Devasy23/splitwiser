      ...
      <div className="max-w-2xl mx-auto">
        ...
        >
          ...
          <button
            ...
            disabled={loading}
            className={`w-full py-4 px-6 flex items-center justify-center gap-3 transition-all focus:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-blue-500 ${isNeo
