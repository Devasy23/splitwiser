...
class TestGroupsRoutes:
    ...
    async def test_create_group_success(self, async_client: AsyncClient, mock_user):
    ...
    async def test_create_group_empty_name(self, async_client: AsyncClient, mock_user):
    ...
    async def test_list_user_groups(self, async_client: AsyncClient, mock_user):
    ...
    async def test_get_group_details(self, async_client: AsyncClient, mock_user):
        ...
        with patch("app.groups.service.group_service.get_group_by_id") as mock_get:
            ...
            response = await async_client.get(f"/groups/{group_id}")
            
            assert response.status_code == status.HTTP_200_OK
            data = response.json()
            assert data["id"] == group_id

    async def test_get_group_not_found(self, async_client: AsyncClient, mock_user):
    ...
    async def test_update_group_metadata(self, async_client: AsyncClient, mock_user):
        ...
        with patch("app.groups.service.group_service.update_group") as mock_update:
            ...
            response = await async_client.patch(f"/groups/{group_id}", json=update_data)
            
            assert response.status_code == status.HTTP_200_OK
            data = response.json()
            assert data["name"] == "Updated Group Name"

    async def test_delete_group(self, async_client: AsyncClient, mock_user):
    ...
    async def test_join_group_by_code(self, async_client: AsyncClient, mock_user):
        ...
        with patch("app.groups.service.group_service.join_group_by_code") as mock_join:
            ...
            response = await async_client.post("/groups/join", json=join_data)
            
            assert response.status_code == status.HTTP_200_OK
            data = response.json()
            assert "group" in data

    async def test_leave_group(self, async_client: AsyncClient, mock_user):
        ...
        with patch("app.groups.service.group_service.leave_group") as mock_leave:
            ...
            response = await async_client.post(f"/groups/{group_id}/leave")
            
            assert response.status_code == status.HTTP_200_OK
            data = response.json()
            assert data["success"] is True

    async def test_get_group_members(self, async_client: AsyncClient, mock_user):
        """Test getting group members"""
        group_id = "642f1e4a9b3c2d1f6a1b2c3d"
        
        with patch("app.groups.service.group_service.get_group_members") as mock_get_members:
    ...
    async def test_update_member_role(self, async_client: AsyncClient, mock_user):
    ...
    async def test_remove_member(self, async_client: AsyncClient, mock_user):
        ...
        with patch("app.groups.service.group_service.remove_member") as mock_remove:
            ...
            response = await async_client.delete(f"/groups/{group_id}/members/{member_id}")
